...
public class Database {
    ...
    public String addRegistration(String fname, String lname, String dname, String sessionid) {
        ...
        Connection conn = getConnection();
        regQuery = ("INSERT INTO registrations (firstname, lastname, displayname, sessionid) values (?, ?, ?, ?);");
        
        try {
            PreparedStatement statement = conn.prepareStatement(regQuery, PreparedStatement.RETURN_GENERATED_KEYS);
